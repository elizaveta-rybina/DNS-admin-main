...
<body>
  <div class="container-main">
    ...
    <div class="add-domain">
      ...
      <a class="add-domain-link" href="#" data-toggle="modal" data-target="#exampleModalDomen">Добавить домен</a>
    </div>
    <div class="main-form">
      <div class="form-head">
  ...
  <form class="modal fade" id="exampleModalDomen" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Название домена:</p>
          <input id="domenInput" class="form-control" type="text" name="Domen">
        </div>
